...
bool AnimationStation::as_traggle = false;
bool AnimationStation::chaseCycleUp = false;
bool AnimationStation::chaseCycleDown = false;
bool AnimationStation::rainbowSpeedUp = false;
bool AnimationStation::rainbowSpeedDown = false;
bool AnimationStation::staticThemeUp = false;
bool AnimationStation::staticThemeDown = false;
...
uint16_t AnimationStation::GetChaseSpeed()
{
  return AnimationStation::options.chaseCycleTime;
}

uint16_t AnimationStation::GetCycleSpeed()
{
  return AnimationStation::options.rainbowCycleTime;
}
