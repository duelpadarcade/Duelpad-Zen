...
public:
  ...
  static uint16_t GetCycleSpeed();
  static uint16_t GetChaseSpeed();
  ...
  static bool as_traggle;
  static bool chaseCycleUp;
  static bool chaseCycleDown;
  static bool rainbowSpeedUp;
  static bool rainbowSpeedDown;
  static bool staticThemeUp;
  static bool staticThemeDown;
  RGB frame[100];
