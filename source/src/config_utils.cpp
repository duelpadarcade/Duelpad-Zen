...
void ConfigUtils::initUnsetPropertiesWithDefaults(Config& config)
{
    ...
    INIT_UNSET_PROPERTY(config.ledOptions, indexA3, LEDS_BUTTON_A3);
    INIT_UNSET_PROPERTY(config.ledOptions, indexA4, LEDS_BUTTON_A4);
...
void profileEnabledFlagsMigration(Config& config) {
    ...
    config.profileOptions.gpioMappingsSets_count = 3;
    config.profileOptions.gpioMappingsSets[0].pins_count = true;
    config.profileOptions.gpioMappingsSets[1].pins_count = true;
    config.profileOptions.gpioMappingsSets[2].pins_count = true;
    config.profileOptions.gpioMappingsSets[3].pins_count = true;
