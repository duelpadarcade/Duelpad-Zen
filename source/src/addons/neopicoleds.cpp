...
void NeoPicoLEDAddon::process()
{
	...
	//action are set in the MainMenuScreen.cpp
	if (AnimationStation::chaseCycleUp | AnimationStation::rainbowSpeedUp | AnimationStation::staticThemeUp )
	{
		/* code */
		action = HOTKEY_LEDS_PARAMETER_DOWN;
		AnimationStation::chaseCycleUp = false;
		AnimationStation::rainbowSpeedUp = false;
		AnimationStation::staticThemeUp = false;
	}else if (AnimationStation::chaseCycleDown | AnimationStation::rainbowSpeedDown | AnimationStation::staticThemeDown )
	{
		/* code */
		action = HOTKEY_LEDS_PARAMETER_UP;
		AnimationStation::chaseCycleDown = false;
		AnimationStation::rainbowSpeedDown = false;
		AnimationStation::staticThemeDown = false;
	}
	...
	if (AnimationStation::as_traggle == true)
	{
		/* code */
		as.SetMode(AnimationStation::options.baseAnimationIndex);
		AnimationStation::as_traggle  = false;
	}
